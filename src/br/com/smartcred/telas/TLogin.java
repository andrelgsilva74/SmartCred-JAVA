...
import java.sql.*;
import br.com.smartcred.dal.ModuloConexao;
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (perfil.equals("admin")) {
                    ...
                    //TPrincipal.mRel.setEnabled(true);
                   // TPrincipal.mCadUsu.setEnabled(true);
                   ...
                   // TPrincipal.lblUsuario.setForeground(Color.red);
                    ...
                    principal.setVisible(true);
                   // TPrincipal.lblUsuario.setText(rs.getString(2));
                   // TPrincipal.lblUsuario.setForeground(Color.blue);
                    this.dispose();
                    conn.close();                    
                }
            } else {
